...
module.exports = {
  ...
  */
  ...
  name: Env.get('APP_NAME', 'Same Day API v2'),
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Get the confiration value to connect a payment provider.
  |
  */
  paymentAPI: {
      iugu: {
          URL: Env.get('IUGU_URL', 'https://api.iugu.com/v1'),
          AuthToken: Env.get('IUGU_AUTH_TOKEN', 'Basic Qzg1NjYwQUFGOTUxOEIzN0E3RDk5RUEwRTJGNzdDRDRCOTYxOEUxM0RGQUU1RkYzQ0NGNEE1MzIwMjQxQjI1Rjo='),
      }
  }
}
